...
class InscriptionInfluenceurOneScreen
    extends GetWidget<InscriptionInfluenceurOneController> {
  @override
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Container(
                    ...
                    padding:
                        getPadding(left: 39, top: 35, right: 39, bottom: 35),
                    child: Column(
  ...
  onSuccessGoogleAuthResponse(GoogleSignInAccount googleUser) {
    Get.toNamed(AppRoutes.homePageScreenInfluenceurScreen);
  }
