...
class Listsixtysix1ItemWidget extends StatelessWidget {
  Listsixtysix1ItemWidget(this.listsixtysix1ItemModelObj,
      {this.onTapImgSixtySix});

  Listsixtysix1ItemModel listsixtysix1ItemModelObj;

  var controller = Get.find<PageNotificationController>();

  VoidCallback? onTapImgSixtySix;
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Obx(
                    () => Text(
                      listsixtysix1ItemModelObj.nameTxt.value,
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        listsixtysix1ItemModelObj.dateTxt.value,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        listsixtysix1ItemModelObj.timeTxt.value,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtNexaLight12Black900,
                      ),
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        listsixtysix1ItemModelObj.personnesCounterTxt.value,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtNexaLight12Black900,
                      ),
